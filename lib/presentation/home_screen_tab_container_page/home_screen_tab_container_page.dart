...
import 'package:my_hotel_booking_app/presentation/home_screen_page/home_screen_page.dart';
...
import 'package:my_hotel_booking_app/widgets/custom_search_view.dart';
...
class HomeScreenTabContainerPageState extends State<HomeScreenTabContainerPage>
                ...
                child: Column(children: [
                  ...
                  Align(
                      ...
                      child: Padding(
                          ...
                          child: Text("msg_hello_daniel".tr,
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        title: AppbarTitle(
            text: "lbl_comfort".tr, margin: EdgeInsets.only(left: 16.h)),
        actions: [
          AppbarTrailingImage(
